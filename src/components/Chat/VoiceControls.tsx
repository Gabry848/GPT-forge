...
const VoiceControls: React.FC<VoiceControlsProps> = ({ onTextReceived, isTyping, currentMessage }) => {
  ...
  // Stati per il riconoscimento vocale
  ...
  const toggleListening = useCallback(() => {
    if (!browserSupportsSpeechRecognition && !setElectronSpeechSupport) {
...
// Removed unused function as the state variable `setElectronSpeechSupport` is now implemented.
